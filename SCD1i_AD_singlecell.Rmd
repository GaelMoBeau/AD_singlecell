...
microglia.DEG <- FindAllMarkers(Microglia, only.pos = T)
write.csv(microglia.DEG %>% group_by(cluster) %>% top_n(n=30, wt=avg_logFC), file = "../tables/microglia_subcluster_DEG.csv" )
...
to.plot <- c("Prolif", "Resting_MG", "IFN_MG", "DA_MG", "Bcl2a1MG")
